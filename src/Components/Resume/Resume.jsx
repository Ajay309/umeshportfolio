...
function Resume() {
  ...
  const skills = {
    ...
    // Added Languages section based on your resume
    languages: [
  ...
  const experience = [
    {
      ...
      period: "2024 - Present", // Updated date based on resume
      achievements: [
        ...
        "Team player, collaborating with marketing and creatives.",
        "Strong with color correction, video compositing, and adding motion graphics.",
        "Create visuals for print, digital media, and branding."
      ]
    },
    // Added Internship
    {
      ...
      achievements: [
        ...
        "Assisted in creating visual content and video editing tasks."
      ]
    }
  ];
        ...
        <main className="main-grid">
          ...
          <aside>
            <div className="glass-panel" style={{ padding: '25px' }}>
              ...
              <div className="tag-cloud" style={{ marginBottom: '30px' }}>
              ...
              <div className="tag-cloud">
                {skills.languages.map((item, index) => (
                  <span key={index} className="tech-tag" style={{borderColor: 'var(--primary-glow)'}}>{item}</span>
                ))}
              </div>
          ...
          <div className="glass-panel content-wrapper">
            ...
            <nav className="nav-container">
              {['about', 'experience', 'education', 'certificates', 'hobbies'].map(tab => (
                <button 
                  key={tab}
                    ...
                    <div key={index} className="timeline-card">
                      <div className="role-header">
                        <div style={{display: 'flex', alignItems: 'center', gap: '10px'}}>
                            <div style={{color: 'var(--primary)'}}><Icons.Award /></div>
                            <div>
                                <div className="role-name">{cert.name}</div>
                                <span className="company-name">{cert.issuer}</span>
                            </div>
                        </div>
                        <span className="year-badge">{cert.date}</span>
                      </div>
                    </div>
                  ))}
                </div>
